...
public abstract class BasePrint {
    ...
    private void getPreferences() {
        ...
        mPrinterInfo.macAddress = sharedPreferences.getString("macAddress", "A4:DA:32:82:DD:90");
        ...
        if (isLabelPrinter(mPrinterInfo.printerModel)) {
            ...
            switch (mPrinterInfo.printerModel) {
                ...
                case QL_820NWB:
                    mPrinterInfo.labelNameIndex = LabelInfo.QL700.valueOf(
                            sharedPreferences.getString("paperSize", "W62RB")).ordinal();
                ...
                case PT_P900W:
                case PT_P950NW:
                    String paper = sharedPreferences.getString("paperSize", "W62RB");
            ...
            mPrinterInfo.paperSize = PrinterInfo.PaperSize
                    .valueOf(sharedPreferences.getString("paperSize", "W62RB"));
        }
        ...
        mPrinterInfo.halftone = PrinterInfo.Halftone.valueOf(sharedPreferences
                .getString("halftone", "PATTERNDITHER"));
        ...
        input = sharedPreferences.getString("customFeed", "0");
        if (input.equals(""))
            input = "0";
        ...
        mPrinterInfo.paperPosition = PrinterInfo.Align
                .valueOf(sharedPreferences.getString("paperPosition", "CENTER"));
        ...
        mPrinterInfo.skipStatusCheck = Boolean.parseBoolean(sharedPreferences
                .getString("skipStatusCheck", "true"));
        ...
        input = sharedPreferences.getString("imageThresholding", "127");
        if (input.equals(""))
            input = "127";
        mPrinterInfo.thresholdingValue = Integer.parseInt(input);

        input = sharedPreferences.getString("scaleValue", "1.0");
        if (input.equals(""))
            input = "0";
        try {
